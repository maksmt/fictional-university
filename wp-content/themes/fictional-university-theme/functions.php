...
function university_adjust_queries($query){
    ...
    if(!is_admin() && is_post_type_archive('event') && !is_post_type_archive('event') && $query->is_main_query()){
        $today = date('Ymd');
        $query->set('meta_key', 'event_day');
...
//Redgirect subscriber accounts out of admin and onto homepage
